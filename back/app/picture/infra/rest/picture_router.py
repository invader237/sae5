...
from app.picture.domain.mapper.picture_to_pictureDTO_mapper import picture_to_pictureDTO_mapper
...
class PictureController:
    def __init__(self):
        ...
        self.router.add_api_route(
            "/", self.get_pictures, response_model=list[PictureDTO], methods=["GET"]
        )

    def get_pictures(self, picture_catalog: PictureCatalog = Depends(get_picture_catalog)):
