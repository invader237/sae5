...
from app.user.domain.mapper.user_to_userDTO_mapper import user_to_userDTO_mapper
...
class UserController:
    def __init__(self):
        ...
        self.router.add_api_route(
            "/", self.get_users, response_model=list[UserDTO], methods=["GET"]
        )

    def get_users(self, user_catalog: UserCatalog = Depends(get_user_catalog)):
